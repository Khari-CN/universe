export default {
  header: {
    ...
    eCommerce: '電子商務平台',
    app: '手機應用程式',
    customization: '企業軟件定製',
    cn: '简体中文',
    tw: '繁體中文',
    en: 'English',
  },
  footer: {
    title: '準備好將你的想法變為現實了嗎？',
  ...
  home: {
    serviceTitle: '我們的服務',
    serviceDes:
      '我們的科技公司專注於提供全面的解決方案，包括客戶關係管理系統(CRM），電子商務平台(E-Commerce)及手機應用程式(APP)開發。我們致力於根據客戶的獨特需求，定制專屬的企業軟件(Enterprise software customization)，幫助企業提升運營效率、增強客戶關係並開拓新的商機。無論是建立高效的客戶管理系統、打造便捷的購物體驗，還是開發創新的移動應用，我們都能提供專業的技術支持和優質的服務，幫助企業數字轉型與長遠發展。',
    crm: '客戶關係管理系統',
    eCommerce: '電子商務平台',
    app: '手機應用程式',
    softwareCustom: '企業軟件定制',
    aboutTitle: '為什麼選擇我們',
    aboutItem1Title: '技術實力與創新',
    aboutItem1Des:
      '我們的團隊由資深技術專家組成，精通最新技術，確保交付的產品處於行業領先水準',
    aboutItem2Title: '敏捷開發流程',
    aboutItem2Des:
      '我們採用敏捷開發方法，確保項目透明、高效，並能快速回應市場變化，讓客戶早日見到成果',
    aboutItem3Title: '持續協作與支援',
    aboutItem3Des:
      '從項目啟動到上線後的長期支援，我們與你緊密溝通，提供持續的技術維護與升級服務',
    clientTitle: '客戶見證',
    clientDes1:
      '與Meta Universe的合作徹底改變了我們的數據處理方式。他們的電子商務平台使我們的運營效率提升了40%',
    clientDes2:
    ...
    clientDes5:
      '市場上有很多技術供應商，但 Meta Universe是真正的合作夥伴。他們深入理解我們的業務目標，並在整個項目過程中與我們並肩作戰，最終交付的成果超出了我們的預期',
    clientDes6:
      '我們被一個棘手的技術難題困擾了數月，內部團隊束手無策。Meta Universe 在短短兩週內就找到了問題根源並提供了快速的解決方案，他們是真正的專家',
  },
  aboutUs: {
